  ...
  <body>
    ...
    <article>
       ...
       <div class="fileupload">
          <form id="uploadfileform" action="uploadfile.php" method="post" enctype="multipart/form-data">
            <input id="fileupload" name="plik" type="file">
       ...
       <div class="fileupload">
          <form id="uploadfilesform" action="uploadfiles.php" method="post" enctype="multipart/form-data">
            <input name="plik1" type="file"><br><br>
            <input name="plik2" type="file"><br><br>
            <input name="plik3" type="file"><br><br>
    ...
    <footer>
      ...
      <div id="sources">
        <a class="myButton" href="source.php?url=upload.php">upload.php</a>
